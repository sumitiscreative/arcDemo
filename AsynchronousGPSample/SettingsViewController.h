...
@property (nonatomic, strong) IBOutlet UISwitch *blueLineSwitch;
@property (nonatomic, strong) IBOutlet UISwitch *blueLineStationSwitch;
@property (nonatomic, strong) IBOutlet UISwitch *redLineSwitch;
@property (nonatomic, strong) IBOutlet UISwitch *redLineStationSwitch;
